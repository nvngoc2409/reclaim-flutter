...
final reclaimTextTheme = TextTheme(
  ...
  titleLarge: GoogleFonts.nunito(textStyle: const TextStyle(fontSize: 22, fontWeight: FontWeight.w800)),
  titleMedium: GoogleFonts.nunito(textStyle: const TextStyle(fontSize: 16, fontWeight: FontWeight.w800)),
  titleSmall: GoogleFonts.nunito(textStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.w800)),
  labelLarge: GoogleFonts.nunito(textStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.w800)),
